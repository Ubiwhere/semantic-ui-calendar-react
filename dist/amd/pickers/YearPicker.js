    ...
    var YearPicker = /** @class */ (function (_super) {
        ...
        */
        function YearPicker(props) {
            ...
            _this.handleChange = function (e, _a) {
                ...
                if (_this.props.onYearChange) {
                    _this.props.onYearChange(e, data);
                }
            ...
            _this.switchToNextPage = function (e, data, callback) {
                _this.setState(function (_a) {
                    ...
                    if (_this.props.onYearChange) {
                        var resData = __assign({}, _this.props, { value: { year: nextDate.year() } });
                        _this.props.onYearChange(e, resData);
                    }
            ...
            _this.switchToPrevPage = function (e, data, callback) {
                _this.setState(function (_a) {
                    ...
                    if (_this.props.onYearChange) {
                        var resData = __assign({}, _this.props, { value: { year: prevDate.year() } });
                        _this.props.onYearChange(e, resData);
                    }
        ...
        YearPicker.prototype.render = function () {
            var _a = this.props, onChange = _a.onChange, value = _a.value, initializeWith = _a.initializeWith, closePopup = _a.closePopup, inline = _a.inline, isPickerInFocus = _a.isPickerInFocus, isTriggerInFocus = _a.isTriggerInFocus, onCalendarViewMount = _a.onCalendarViewMount, disable = _a.disable, enable = _a.enable, minDate = _a.minDate, maxDate = _a.maxDate, localization = _a.localization, onYearChange = _a.onYearChange, rest = __rest(_a, ["onChange", "value", "initializeWith", "closePopup", "inline", "isPickerInFocus", "isTriggerInFocus", "onCalendarViewMount", "disable", "enable", "minDate", "maxDate", "localization", "onYearChange"]);
