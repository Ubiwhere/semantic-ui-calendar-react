    ...
    var DateInput = /** @class */ (function (_super) {
        ...
        function DateInput(props) {
            ...
            _this.getPicker = function () {
                ...
                if (mode === 'year') {
                    return (React.createElement(YearPicker_1.default, __assign({}, pickerProps, { onYearChange: _this.onPopupYearChange, disable: shared_1.getDisabledYears(disableParsed) })));
                }
                if (mode === 'month') {
                    return (React.createElement(MonthPicker_1.default, __assign({}, pickerProps, { hasHeader: true, onYearChange: _this.onPopupYearChange, onMonthChange: _this.onPopupMonthChange, disable: shared_1.getDisabledMonths(disableParsed) })));
                }
                return React.createElement(DayPicker_1.default, __assign({}, pickerProps, { disable: disableParsed, marked: markedParsed, markColor: markColor, onMonthChange: _this.onPopupMonthChange }));
            };
            ...
            _this.onPopupMonthChange = function (e, _a) {
                var value = _a.value;
                var outValue = moment_1.default(value).format(_this.props.dateFormat);
                invoke_1.default(_this.props, 'onMonthChange', e, __assign({}, _this.props, { value: outValue }));
            };
            _this.onPopupYearChange = function (e, _a) {
                var value = _a.value;
                var outValue = moment_1.default(value).format(_this.props.dateFormat);
                invoke_1.default(_this.props, 'onYearChange', e, __assign({}, _this.props, { value: outValue }));
            };
        ...
        DateInput.prototype.render = function () {
            var _this = this;
            var _a = this.props, value = _a.value, dateFormat = _a.dateFormat, initialDate = _a.initialDate, disable = _a.disable, enable = _a.enable, maxDate = _a.maxDate, minDate = _a.minDate, preserveViewMode = _a.preserveViewMode, startMode = _a.startMode, closable = _a.closable, markColor = _a.markColor, marked = _a.marked, localization = _a.localization, onChange = _a.onChange, onMonthChange = _a.onMonthChange, onYearChange = _a.onYearChange, rest = __rest(_a, ["value", "dateFormat", "initialDate", "disable", "enable", "maxDate", "minDate", "preserveViewMode", "startMode", "closable", "markColor", "marked", "localization", "onChange", "onMonthChange", "onYearChange"]);
