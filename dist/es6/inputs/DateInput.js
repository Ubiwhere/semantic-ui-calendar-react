...
var DateInput = /** @class */ (function (_super) {
    ...
    function DateInput(props) {
        ...
        _this.getPicker = function () {
            ...
            if (mode === 'year') {
                return (React.createElement(YearPicker, __assign({}, pickerProps, { onYearChange: _this.onPopupYearChange, disable: getDisabledYears(disableParsed) })));
            }
            if (mode === 'month') {
                return (React.createElement(MonthPicker, __assign({}, pickerProps, { hasHeader: true, onYearChange: _this.onPopupYearChange, onMonthChange: _this.onPopupMonthChange, disable: getDisabledMonths(disableParsed) })));
            }
            return React.createElement(DayPicker, __assign({}, pickerProps, { disable: disableParsed, marked: markedParsed, markColor: markColor, onMonthChange: _this.onPopupMonthChange }));
        };
        ...
        _this.onPopupMonthChange = function (e, _a) {
            var value = _a.value;
            var outValue = moment(value).format(_this.props.dateFormat);
            invoke(_this.props, 'onMonthChange', e, __assign({}, _this.props, { value: outValue }));
        };
        _this.onPopupYearChange = function (e, _a) {
            var value = _a.value;
            var outValue = moment(value).format(_this.props.dateFormat);
            invoke(_this.props, 'onYearChange', e, __assign({}, _this.props, { value: outValue }));
        };
